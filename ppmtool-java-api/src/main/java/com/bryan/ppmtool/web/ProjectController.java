...
public class ProjectController {
	...
	public ResponseEntity<?> findProjectByProjectId(@PathVariable("projectId") String projectIdentifier) {
	...
	public ResponseEntity<?> deleteProject(@PathVariable("projectId") String projectIdentifier) {
